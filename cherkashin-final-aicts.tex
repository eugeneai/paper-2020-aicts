...
In \cite{muller16}, a data-driven user interface and visualization is considered in the process of a clinical decision support system implementation. The user interface supplies decision-making for doctors and explanations for patients as list of events of various kinds (medical records, NGS results over autopsy tissue, \emph{etc.}) represented as HTML5 portlets. A comprehensive review of quality control, error detection and correction in processing NGS data is presented in \cite{te16}. %, it would be of purpose to implement them [within our software].
...
% compliance IOP Conference Series format
...
\bibitem{underice} Bashenkhaeva M V, Zakharova Yu R, Petrova D P \emph{et al} 2015 Sub-ice microalgal and bacterial communitie in freshwater lake Baikal, Russia \emph{Environmental Microbiology} \textbf{70} No.~3 751--65. \doi{10.1007/s00248-015-0619-2}
