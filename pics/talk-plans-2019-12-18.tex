...
\title{Working plan for this week}
\author[E.~Cherkashin]{\bfseries%
  Evgeny Cherkashin}
\institute{\normalsize Matrosov Institute for System Dynamics and Control Theory of Siberian Branch of Russian Academy of Sciences (ISDCT SB RAS), Irkutsk, Russia\\%
...
\begin{frame}
  ...
  \textbf{Main objective} is to find applications of the research done in ISDCT SB RAS to problems stated in LSU. To form our collaborative scientific research direction we need:
  \begin{enumerate}
  \item A problem,
  \item Resources of LSU (infrastructure, equipment, scientists, students and study programs for them),
  \item Related scientific background of ISDCT SB RAS.
  \end{enumerate}
  \textbf{We suppose} to find applications (primary but not limited to) form
  \begin{itemize}
  \item Big Data, e.g., acquired from Oil domain, sensor networks;
  \item Logical inference over domain models with software synthesis;
  \item Our machine learning algorithms for non convex problems.
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Plan of activities}
  Igor V. Bychkov instructed me to do the following:
  \begin{enumerate}
  \item Deduce organizational structures of all colleges related to computer science;
  \item Figure out subdivisions (laboratories, chairs, etc.) of the colleges;
  \item Research an development directions for all the subdivisions;
  \item Find related problems (the current and future vision);
  \item Mediate the problems with our scientific background.
  \end{enumerate}
\end{frame}

\begin{frame}
  \frametitle{Planinng by day}
  \begin{enumerate}
  \item Tree days for attending colleges (one for each college);
  \item Two days for mediation of interest for two problems (with 2-4 scientific supervisors);
    \begin{itemize}
    \item Further collection of papers in English and list of titles (in English) published in Chinese;
    \end{itemize}
  \item One (the last) day devolved for a protocol defining year 2020 research activity (in form of a project application or a specification).
    \begin{itemize}
    \item Staff from both sides;
    \item Requirements.
    \end{itemize}
  \end{enumerate}
\end{frame}
...
\begin{frame}
  \frametitle{ISDCT SB RAS structure}
  The structure is presented in Russian at \url{http://idstu.irk.ru/ru/orgsection} (English \url{http://idstu.irk.ru/en/orgsection}). Scientific subdivisions are as follows:
  \begin{itemize}
  \item Department 1. Evolution equations and controllable dynamical systems.
    \begin{itemize}
    \item Laboratory 1.1. Mathematical methods of analysis of
      properties in dynamical systems.
    \item Laboratory 1.2. Optimal control.
    \end{itemize}
\item Department 2. Problems of application of mathematical physics and field theory.
\item Department 3. Dynamic properties and control of complex objects in space..
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{ISDCT SB RAS structure (continuation)}
  \begin{itemize}
\item Department 4. Information Technology and Systems.
  \begin{itemize}
  \item Laboratory 4.1. Integrated information systems.
  \item Laboratory 4.2. Information and telecommunication technologies of natural and man-caused safety research.
\end{itemize}
\item Department 5. Computing and control systems.
  \begin{itemize}
  \item Laboratory 5.1. Parallel and distributed computing systems.
  \item Laboratory 5.2. Information and Control Systems.
\end{itemize}
\item Department 6. Methods of nonconvex and combinatorial optimizations.
  \begin{itemize}
  \item Laboratory 6.1. Methods of nonconvex optimization.
  \item Laboratory 6.2. Logical and optimization methods for analyzing complex systems.
\end{itemize}
  \end{itemize}
\end{frame}
